...
export default class BookList extends Component {
    ...
    findAllBooks(currentPage) {
        ...
        axios.get("http://localhost:8093/rest/books?pageNumber="+currentPage+"&pageSize="+this.state.booksPerPage+"&sortBy=price&sortDir="+sortDir)
    ...
    deleteBook = (bookId) => {
        axios.delete("http://localhost:8093/rest/books/"+bookId)
            .then(response => {
    ...
    searchData = (currentPage) => {
        currentPage -= 1;
        axios.get("http://localhost:8093/rest/books/search/"+this.state.search+"?page="+currentPage+"&size="+this.state.booksPerPage)
            .then(response => response.data)
            .then((data) => {
                this.setState({
                    books: data.content,
