...
export default class Book extends Component {
    ...
    findAllLanguages = () => {
        axios.get("http://localhost:8093/rest/books/languages")
    ...
    findAllGenres = () => {
        axios.get("http://localhost:8093/rest/books/genres")
            .then(response => response.data)
            .then((data) => {
                this.setState({
    ...
    findBookById = (bookId) => {
        axios.get("http://localhost:8093/rest/books/"+bookId)
            .then(response => {
    ...
    submitBook = event => {
        ...
        axios.post("http://localhost:8093/rest/books", book)
            .then(response => {
                if(response.data != null) {
                    this.setState({"show":true, "method":"post"});
                    setTimeout(() => this.setState({"show":false}), 3000);
    ...
    updateBook = event => {
        ...
        axios.put("http://localhost:8093/rest/books", book)
            .then(response => {
                if(response.data != null) {
                    this.setState({"show":true, "method":"put"});
                    setTimeout(() => this.setState({"show":false}), 3000);
